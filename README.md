...
- **Voice**: WebRTC, real-time audio pipeline
- **Agent**: Claude/Multi-model orchestration
- **Scoring**: Rule-based rubric engine + LLM-assisted evaluation
- **Feedback**: Structured output per stage, per scenario
- **Demo**: React/HTML5 frontend, live scenario runner
...
# Configure .env with model API keys
cp .env.example .env
